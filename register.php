...
<body>
    ...
    <table style="border: 2px solid black; width: 40%;" align="center">
        ...
        <tr><td>ชื่อบัญชี:</td><td><input type="text" name="user" size="30" required></td></tr>
        <tr><td>รหัสผ่าน:</td><td><input type="password" name="password" size="30" required></td></tr>
        <tr><td>ชื่อ-นามสกุล:</td><td><input type="full-name" name="full-name" size="30" required></td></tr>
        <tr><td><label for="gender">เพศ :</label><br></td>
            <td><input type="radio" value="m">ชาย<br>
            <input type="radio"  value="f">หญฺิง<br>
            <input type="radio"  value="#">อื่นๆ</td></tr>
